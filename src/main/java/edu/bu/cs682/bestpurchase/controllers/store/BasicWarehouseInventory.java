...
import edu.bu.cs682.bestpurchase.entities.store.Warehouse;
import edu.bu.cs682.bestpurchase.exceptions.BestPurchaseAppException;
import edu.bu.cs682.bestpurchase.interfaces.databases.EmployeeDatabase;
import edu.bu.cs682.bestpurchase.interfaces.databases.ItemDatabase;
...
public class BasicWarehouseInventory implements WarehouseInventory {
    ...
    public BasicWarehouseInventory(Warehouse warehouse,
        ...
        var items = List.of(
                        Tuple.of(new Item(IdType.toIdType("adb8d524-32af-47eb-a192-5e483ef70325", "hotdog"), "Sony",
                                        "Hotdog Multiplexer", 129.99), 42),

                        Tuple.of(new Item(IdType.toIdType("4c7b7a66-ed71-11ec-8ea0-0242ac120002", "ketchup"), "Heinz",
                                        "Dehydrated Ketchup", 4.99), 19),

                        Tuple.of(new Item(IdType.toIdType("534d02ba-ed71-11ec-8ea0-0242ac120002", "bread"), "Kirkland",
